...
#
#     result = ProdutoDTOfromdict(json.loads(json_string))
...
class Data:
    ...
    def from_dict(obj: Any) -> 'Data':
        ...
        return Data(nome, descricao, imagem, categoria, valor, valorDe, disponibilidade, foraDeLinha, idLojista, dadosEntrega)
...
def ProdutoDTOfromdict(s: Any) -> ProdutoDTO:
    return ProdutoDTO.from_dict(s)


def ProdutoDTOtodict(x: ProdutoDTO) -> Any:
    return to_class(ProdutoDTO, x)
